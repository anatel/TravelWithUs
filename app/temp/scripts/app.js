	...
	var StickyHeader = function () {
		...
		_createClass(StickyHeader, [{
			...
			value: function createHeaderWaypoint() {
				var that = this;
				new Waypoint({
					element: this.headerTriggerElement[0], //we can't write this.headerTriggerElement because it's a jquery object, and we want to send a JS native DOM element. in [0] there's a pointer to the native DOM element.
			...
			//Added to remove the highlight from the "Our Beginning" link when scrolling up out of it.
	...
	var Modal = function () {
		...
		_createClass(Modal, [{
			...
			value: function openModal() {
				...
				/* We include this because the header "Get in Touch" button is a link element, 
	   and if we click a link element that has an href value of "#" the browser automatically 
	   scrolls to the top of the page, which we don't want. 
	   "return false" will prevent that default behaviour of scrolling up. */
				return false;
			}
		}, {
			key: "closeModal",
